...
std::string ReportPrintable::getBsmXml(BSM bsm){
...
std::string ReportPrintable::getBsmJson(BSM bsm){
    ...
    tempStr = jw.getSimpleTag("RealId", std::to_string(bsm.getSenderAddress().getInt()) ,true);
    jw.addTagToElement("Bsm", tempStr);
