...
/**
   *  @brief run through all the checks results, and search for the minimum (most critical factor)
*/
...
void MDApplication::incrementDetailedFlags(BSM * bsm,BsmCheck * bsmCheck, double Threshold) {
