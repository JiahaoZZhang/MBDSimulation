...
void Kalman_SVI::getDeltaPos(float T, float _X, float _Y, float _VX, float _VY, float _AX, float _AY, float CX, float CY, float CVX, float CVY, float * Delta){
    ...
    // cout<< "cur[0] ::" << X0[0] << endl;
    // cout<< "cur[1] ::" << X0[1] << endl;
    // cout<< "cur[2] ::" << X0[2] << endl;
    // cout<< "cur[3] ::" << X0[3] << endl;

    kalmanFilterJ_SVI.predict(U);
    kalmanFilterJ_SVI.correct(X0);

    // cout<< "kalmanFilterJ_SVI.X[0] ::" << kalmanFilterJ_SVI.X[0] << endl;
    // cout<< "kalmanFilterJ_SVI.X[1] ::" << kalmanFilterJ_SVI.X[1] << endl;
    // cout<< "kalmanFilterJ_SVI.X[2] ::" << kalmanFilterJ_SVI.X[2] << endl;
    // cout<< "kalmanFilterJ_SVI.X[3] ::" << kalmanFilterJ_SVI.X[3] << endl;
    // cout<< "X0[0] ::" << X0[0] << endl;
    // cout<< "X0[1] ::" << X0[1] << endl;
    // cout<< "X0[2] ::" << X0[2] << endl;
    // cout<< "X0[3] ::" << X0[3] << endl;
