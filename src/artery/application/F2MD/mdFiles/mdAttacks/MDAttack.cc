...
/**
   *  @brief initialize the attack that will be further be added to the CAM (Calculate constant offset, positions and vairious constant attacks parameters)
   *  @param attackTypes::Attacks my attack type
   *  @param double various maximum plausible caracteristics
   *  @param F2MD_CAMParameters* CAM Parameters
*/
void MDAttack::init(attackTypes::Attacks myAttackType, double MaxRandomPosX, double MaxRandomPosY, double MinRandomPosX, double MinRandomPosY, F2MD_CAMParameters *params) {
    ...
    this->MinRandomPosX = MinRandomPosX;
    this->MinRandomPosY = MinRandomPosY;

    SybilMyOldPseudo = (*myPseudonym);
    SybilVehSeq = 0;

    ConstPosX = genLib.RandomDouble(MinRandomPosX, MaxRandomPosX);
    ConstPosY = genLib.RandomDouble(MinRandomPosY, MaxRandomPosY);
...
void MDAttack::setMyBsm(BSM* myBsm) {
    this->myBsm = myBsm;
}
...
/**
   *  @brief creates a BSM with the desired attack
   *  @param attackTypes::Attacks my attack type
   *  @param LinkControl* Link Control
   *  @result returns a BSM with the desired attack
*/
BSM MDAttack::launchAttack(attackTypes::Attacks myAttackType,
        LinkControl* LinkC) {
    ...
    case attackTypes::RandomPos: {
        ...
        double randPosX = genLib.RandomDouble(MinRandomPosX, MaxRandomPosX);
        double randPosY = genLib.RandomDouble(MinRandomPosY, MaxRandomPosY);
    ...
    case attackTypes::DoSRandom: {
        ...
        double x = genLib.RandomDouble(MinRandomPosX, MaxRandomPosX);
        double y = genLib.RandomDouble(MinRandomPosY, MaxRandomPosY);
