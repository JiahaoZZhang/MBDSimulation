...
/**
   *  @brief  creates a node MDMHistory that will save for a defined period the results of checks based on Kalman Filtering
*/
...
/**
   *  @brief  adds the results of the checks in the MDM history
*/
...
void MDMHistory::initKalman(BSM * bsm, int version) {
    switch (version) {
    case 1: {
