...
/**
   *  @brief create a new Legacy checks configuration
*/
LegacyChecks::LegacyChecks(int version, unsigned long myPseudonym,
    ...
    veins::Coord myLimits, LinkControl* LinkC, std::unordered_map<int, veins::Coord>* realDynamicMap, inet::MACAddress myId, F2MD_CAMParameters* params)
{
...
*/
BsmCheck LegacyChecks::CheckBSM(BSM* bsm,
